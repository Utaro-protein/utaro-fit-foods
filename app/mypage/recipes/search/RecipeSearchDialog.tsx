...
import { hasActiveSearchFilters, type RangeState, type RecipeSearchBounds } from "./recipeSearchRange";
...
export function RecipeSearchDialog({ bounds, ranges }: Props) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      {active ? <span className="text-xs font-medium text-emerald-800">絞り込み中</span> : null}
    </div>
  );
}
